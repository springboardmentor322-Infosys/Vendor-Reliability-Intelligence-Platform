...
target_actions = '''<td class="p-3.5 border-b border-white/5 flex gap-2">
                                <button class="text-[10px] bg-indigo-500/20 text-indigo-400 px-2 py-1 rounded hover:bg-indigo-500/40" onclick="uploadInvoice()">Upload Invoice</button>
                                <button class="text-[10px] bg-emerald-500/20 text-emerald-400 px-2 py-1 rounded hover:bg-emerald-500/40" onclick="updateDelivery()">Mark Delivered</button>
                            </td>'''

replacement_actions = '''<td class="p-3.5 border-b border-white/5 flex flex-wrap gap-2">
                                <button class="text-[10px] bg-indigo-500/20 text-indigo-400 px-2 py-1 rounded hover:bg-indigo-500/40" onclick="uploadInvoice()">Upload</button>
                                <button class="text-[10px] bg-emerald-500/20 text-emerald-400 px-2 py-1 rounded hover:bg-emerald-500/40" onclick="updateDelivery()">Delivered</button>
...
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated vendor_dashboard.html")
