...
export class ReliabilityComponent implements OnInit {
  ...
  ngOnInit(){
    this.http.get<any[]>('https://vendor-reliability-intelligence-platform-2h9h.onrender.com/reliability/').subscribe({next:r=>this.rows=r,error:e=>console.error(e)});
    this.http.get<any>('https://vendor-reliability-intelligence-platform-2h9h.onrender.com/reliability/summary').subscribe({next:r=>this.summary=r,error:e=>console.error(e)});
  }
}
