...
Revision ID: 4ea92fb5ac75
Revises: 5e770fef4bd1
Create Date: 2026-08-13 00:45:33.551916
...
revision: str = '4ea92fb5ac75'
down_revision: Union[str, Sequence[str], None] = '5e770fef4bd1'
...
def downgrade() -> None:
    ...
    sa.Column('defects_found', sa.INTEGER(), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['purchase_order_id'], ['purchase_orders.id'], name=op.f('quality_inspections_purchase_order_id_fkey'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['vendor_id'], ['vendors.id'], name=op.f('quality_inspections_vendor_id_fkey'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('quality_inspections_pkey'))
    )
