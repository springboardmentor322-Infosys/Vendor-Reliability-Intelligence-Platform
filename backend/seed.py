"""
Run this once after starting the app for the first time to populate sample data:
    python seed.py
"""
...
if db.query(models.Vendor).count() == 0:
    ...
    vendors_data = [
        (
            "Bharat Steel Works",
            models.VendorCategoryEnum.RAW_MATERIAL,
            models.VendorStatusEnum.APPROVED,
        ),
        (
            "TechNova IT Solutions",
            models.VendorCategoryEnum.IT,
            models.VendorStatusEnum.APPROVED,
        ),
        (
            "Swift Logistics Pvt Ltd",
            models.VendorCategoryEnum.LOGISTICS,
            models.VendorStatusEnum.APPROVED,
        ),
        (
            "Precision Equipment Co.",
            models.VendorCategoryEnum.EQUIPMENT,
            models.VendorStatusEnum.PENDING,
        ),
        (
            "CleanServ Facility Services",
            models.VendorCategoryEnum.SERVICE,
            models.VendorStatusEnum.APPROVED,
        ),
        (
            "Apex Maintenance Group",
            models.VendorCategoryEnum.MAINTENANCE,
            models.VendorStatusEnum.SUSPENDED,
        ),
    ]
    ...
    for vid, ot, dl, q, rt, ir, cr in perf_data:
        db.add(
            models.PerformanceRecord(
                vendor_id=vid,
                on_time_deliveries=ot,
                delayed_deliveries=dl,
                quality_rating=q,
                response_time_hours=rt,
                issue_resolution_hours=ir,
    ...
    contracts_data = [
        ...
        (
            ...
            models.ComplianceStatusEnum.AT_RISK,
        ),
        (
            vendors[5].id,
            ...
            models.ComplianceStatusEnum.NON_COMPLIANT,
        ),
    ]
    ...
    po_data = [
        ...
        (
            vendors[1].id,
            "Annual software licenses (50 seats)",
            50,
            4200,
        ...
        (
            vendors[4].id,
            "Facility deep-cleaning contract",
            1,
            35000,
    ...
    db.add(
        models.Message(
            ...
            content="Please confirm dispatch schedule for the freight order.",
        )
    )
    ...
    db.add(
        models.Message(
            vendor_id=vendors[2].id,
            sender=vendors[2].name,
            content="Dispatch confirmed for next Monday, 9 AM.",
        )
    )
    ...
    db.add(
        models.Notification(
            ...
            message="Logistics Service Contract expires soon.",
    ...
    print(
        "Sample vendors, performance data, contracts, "
        "purchase orders and messages seeded."
    )

else:
    print("Vendors already exist - skipping sample data seeding.")
